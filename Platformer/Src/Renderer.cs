...
namespace Platformer {
	...
	public class Renderer {
		...
		public void RenderEntity(Entity entity, Camera camera, SpriteBatch spriteBatch) {
            ...
            spriteBatch.Draw(sprite.SpriteSheet, new Rectangle(destX + entity.SpriteOffset.X, destY + entity.SpriteOffset.Y, destW, destH), new Rectangle(srcX, srcY, srcW, srcH), Color.White);
            spriteBatch.End();
			...
			if (Consts.DEBUG_MODE) {
				Images.DebugRect.SetData(new[] { new Color(255, 0, 0, 50) });
