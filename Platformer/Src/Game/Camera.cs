...
namespace Platformer {
	...
	public class Camera {
		...
		public void Update() {
			pos = new Vector2(entity.Pos.X, 200); //Vector2.Lerp(this.pos, entity.Pos, lerpAmount);
		...
		public Vector2 getPos() {
			return new Vector2(this.pos.X - Consts.GameWidth/2, this.pos.Y - Consts.GameHeight/2);
		}
	}
}
