...
namespace Platformer {
    public class Sprite {
        ...
        public void FlashSprite(int flashCount, float flashDuration=0.05f, Color? flashColor=null, bool isTint=false) {
            FlashColor = flashColor ?? Color.White;
            flashesLeft = 2 * flashCount;
            lastFlashTime = 0;
